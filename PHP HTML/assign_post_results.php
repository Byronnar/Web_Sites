...
if($_SESSION['user']=="") 
{
    header('Location: ./assign_level4.php');
}  else {
    

$query = "SELECT * FROM users WHERE username='$session_user'";  //Choose the current users information
...
<table id="list">
   ...
   <!-- the below form is for the editing and deleting comments-->
          <form action="./trans.php" name="authform" method="POST">
